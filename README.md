...
## About me:
My current preferred language is Java. I’m comorteble with JS (use React), but also some SQL, CSS and tailwind. I can administrate and create REST-APIs, know about data structures and design principles. I have also administrated PaaS in Azure, know a little about containerization with Docker and Ci/CD-pipeline. I have been working a lot with git and can work with DevOps platforms. 
...
### 📖 I’m currently learning:
 ...
 - C++: Just having fun with youtube-vidioes and playing a little arround in my code-editor.
